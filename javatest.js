...
let doneCollection = document.getElementsByClassName('firstOption')
/*function gray(id){
    for (let i = 0;i < doneCollection.length;i++){
        if (i === id){
            if (doneCollection[i].style.display == 'none'){
                doneCollection[i].style.display = 'inline'
            }
            else if (doneCollection[i].style.display == 'inline'){
                doneCollection[i].style.display = 'none'
            }
        }
    }
}*/
...
function gray(id){
    if (doneCollection[id].className == 'firstOption'){
        doneCollection[id].className == 'secondOption'
    }
    else if (doneCollection[id].className == 'secondOption'){
        doneCollection[id].className == 'firstOption'
    }
}
